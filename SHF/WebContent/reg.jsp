                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="Login" autocomplete="on"> 
                                <h1>Log in</h1> 
                                <p> 
                                    <label for="emailsignup" class="youmail" data-icon="u" > Your Username</label>
                                    <input id="emailsignup" name="name" required="required" type="name" placeholder="rockz123"/> 
                                </p>
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form  action="Registration" autocomplete="on"> 
                                <h1> Sign up </h1> 
                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Your full name</label>
